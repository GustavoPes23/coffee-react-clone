...
export const Product = (props: ProductProps): string => {
    const productId = props.id;
    const foundProduct: IProductsProps | undefined = AllProducts.find((item: IProductsProps): boolean => item.id === Number(productId));
...
const getRatingStars = (rating: number | undefined): string => {
